...
* Έψαξα στο google και βρήκα μια φωτογραφία από το Βιομηχανικό Μουσείο και την ανέβασα στα assets.
* Έψαξα στο google και βρήκα τις συντεταγμένες (**latitude** και **longitude**) από το Βιομηχανικό Μουσείο και τις πρόσθεσα στον κώδικα.
* Ο κώδικας που χρησιμοποίησα για να εντάξω την φωτογραφία είναι [code_image](https://aframe.io/docs/1.3.0/primitives/a-image.html#sidebar)
